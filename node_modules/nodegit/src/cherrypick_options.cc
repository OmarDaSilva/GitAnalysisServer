...
nodegit::ConfigurableClassWrapper<GitCherrypickOptionsTraits>::v8ConversionResult ConfigurableGitCherrypickOptions::fromJavascript(nodegit::Context *nodegitContext, v8::Local<v8::Value> input) {
  if (!input->IsObject()) {
    return {
  ...
  // unpack the data into the correct fields
         {
          ...
          if (!maybeNumber.IsEmpty() && !maybeNumber->IsUndefined() && !maybeNumber->IsNull()) {
           ...
           {
          v8::Local<v8::Value> maybeNumber = nodegit::safeGetField(inputObj, "mainline");
          if (!maybeNumber.IsEmpty() && !maybeNumber->IsUndefined() && !maybeNumber->IsNull()) {
            if (!maybeNumber->IsNumber()) {
              return {
            ...
            output->raw->mainline = static_cast<unsigned int>(maybeNumber->Int32Value(Nan::GetCurrentContext()).FromJust());
          }
        }
          {
          v8::Local<v8::Value> maybeNestedObject = nodegit::safeGetField(inputObj, "mergeOpts");
