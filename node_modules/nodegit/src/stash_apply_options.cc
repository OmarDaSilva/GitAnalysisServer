...
nodegit::ConfigurableClassWrapper<GitStashApplyOptionsTraits>::v8ConversionResult ConfigurableGitStashApplyOptions::fromJavascript(nodegit::Context *nodegitContext, v8::Local<v8::Value> input) {
  if (!input->IsObject()) {
    return {
  ...
  return {
    output
      ...
      void ConfigurableGitStashApplyOptions::progressCb_async(void *untypedBaton) {
        ...
        if (PromiseCompletion::ForwardIfPromise(result, baton, ConfigurableGitStashApplyOptions::progressCb_promiseCompleted)) {
          return;
        }
      ...
      void ConfigurableGitStashApplyOptions::progressCb_promiseCompleted(bool isFulfilled, nodegit::AsyncBaton *_baton, v8::Local<v8::Value> result) {
        Nan::HandleScope scope;
