  ...
  private:
    ...
    class CherrypickWorker : public nodegit::AsyncWorker {
      public:
        ...
        ) : nodegit::AsyncWorker(callback, "nodegit:AsyncWorker:GitCherrypick:Cherrypick", cleanupHandles)
          , baton(_baton) {};
    ...
    class CommitWorker : public nodegit::AsyncWorker {
      public:
        CommitWorker(
            ...
            Nan::Callback *callback,
            std::map<std::string, std::shared_ptr<nodegit::CleanupHandle>> &cleanupHandles
        ) : nodegit::AsyncWorker(callback, "nodegit:AsyncWorker:GitCherrypick:Commit", cleanupHandles)
          , baton(_baton) {};
