  ...
  private:
    ...
    class NextWorker : public nodegit::AsyncWorker {
      public:
        ...
        ) : nodegit::AsyncWorker(callback, "nodegit:AsyncWorker:GitRevwalk:Next", cleanupHandles)
          , baton(_baton) {};
    ...
    class CommitWalkWorker : public nodegit::AsyncWorker {
      public:
        CommitWalkWorker(
            ...
            Nan::Callback *callback,
            std::map<std::string, std::shared_ptr<nodegit::CleanupHandle>> &cleanupHandles
        ) : nodegit::AsyncWorker(callback, "nodegit:AsyncWorker:GitRevwalk:CommitWalk", cleanupHandles)
          , baton(_baton) {};
    ...
    class FastWalkWorker : public nodegit::AsyncWorker {
      public:
        FastWalkWorker(
            ...
            Nan::Callback *callback,
            std::map<std::string, std::shared_ptr<nodegit::CleanupHandle>> &cleanupHandles
        ) : nodegit::AsyncWorker(callback, "nodegit:AsyncWorker:GitRevwalk:FastWalk", cleanupHandles)
          , baton(_baton) {};
    ...
    class FileHistoryWalkWorker : public nodegit::AsyncWorker {
      public:
        FileHistoryWalkWorker(
            ...
            Nan::Callback *callback,
            std::map<std::string, std::shared_ptr<nodegit::CleanupHandle>> &cleanupHandles
        ) : nodegit::AsyncWorker(callback, "nodegit:AsyncWorker:GitRevwalk:FileHistoryWalk", cleanupHandles)
          , baton(_baton) {};
